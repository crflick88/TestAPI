...
var route = function(Bear){
    ...
    bearRouter.route('/:bear_id')
        ...
        // completelly update the bear with this id (accessed at PUT http://localhost:8080/api/bears/:bear_id)
        ...
        // partially update the bear with this id (accessed at PATCH  http://localhost:8080/api/bears/:bear_id)
